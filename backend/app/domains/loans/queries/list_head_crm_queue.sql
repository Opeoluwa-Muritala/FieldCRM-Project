-- Loans awaiting Head CRM approval.
-- Params: $1=org_id, $2=limit, $3=offset
SELECT
    la.id, la.ref_no, la.applicant_name, la.amount, la.loan_type, la.stage,
    la.created_at, la.updated_at, u.full_name AS officer_name,
...
WHERE la.org_id = $1 AND la.stage = 'head_crm_review' AND la.deleted_at IS NULL
