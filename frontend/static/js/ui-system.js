(function () {
  ...
  document.addEventListener('click', function (event) {
    ...
    var cancel = document.createElement('button'); cancel.type = 'button'; cancel.textContent = 'Cancel'; cancel.className = 'btn btn-secondary action-secondary-ghost';
    var proceed = document.createElement('button'); proceed.type = 'button'; proceed.textContent = 'Confirm';
    if (control.classList.contains('action-danger') || control.classList.contains('btn-danger')) proceed.className = 'btn action-danger';
    else if (control.classList.contains('action-warning')) proceed.className = 'btn action-warning';
    else if (control.classList.contains('action-secondary-filled')) proceed.className = 'btn action-secondary-filled';
    else if (control.classList.contains('action-secondary-outlined')) proceed.className = 'btn action-secondary-outlined';
    else proceed.className = 'btn action-primary';
    var actions = document.createElement('div'); actions.className = 'confirmation-actions';
    ...
    actions.append(cancel, proceed); panel.append(message, actions); document.body.append(backdrop, panel); document.addEventListener('keydown', onKey); proceed.focus();
  });
